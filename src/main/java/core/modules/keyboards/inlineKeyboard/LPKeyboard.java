...
public class LPKeyboard {
    ...
    static{
        ...
        line1.add(new KeyboardButton().setAction(new KeyboardButtonAction().setLabel("Подробнее")
                .setType(TemplateActionTypeNames.OPEN_LINK).setLink("https://www.sut.ru/university/structure/podrazdeleniya-prorektora-po-nauchnoy-rabote/nauchno-issledovatelskiy-institut-tehnologiy-svyazi/nauchno-obrazovatelniy-centr-laboratoriya-programmirovaniya")));
